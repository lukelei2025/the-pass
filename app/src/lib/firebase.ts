...
// 🔒 确保 Auth 持久化优先使用 IndexedDB (indexedDBLocalPersistence)
// 在 initializeAuth 中已配置，移除旧的 setPersistence 调用。
console.log('[Firebase] ✅ Auth initialized with indexedDBLocalPersistence fallback to browserLocalPersistence');
