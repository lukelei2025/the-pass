...
${(metadata === null || metadata === void 0 ? void 0 : metadata.isLink) ? `(系统检测事实: 包含链接 ${metadata.originalUrl}, 标题 "${metadata.title || ''}")` : ''}
...
`;
            const response = await axios_1.default.post(GLM_API_URL, {
                model: 'glm-4',
                messages: [
                    {
                        role: 'user',
            ...
            let rawContent = (_d = (_c = (_b = (_a = data.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.trim();
            ...
            console.error('Error calling GLM API:', ((_e = error.response) === null || _e === void 0 ? void 0 : _e.data) || error.message);
